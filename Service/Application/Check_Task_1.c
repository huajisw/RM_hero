...
void set_message()
{
   // cap_send_data.chassis_power_buffer = judge_sensor.info->power_heat_data.chassis_power_buffer;
    ...
    cap_send_data.chassis_power_buffer = DJI_Judge.DJI_Judge_Mes.Judge_power_heat_data.chassis_power_buffer;
	
	  cap_send_data.chassis_power_limit = DJI_Judge.DJI_Judge_Mes.Judge_game_robot_status.chassis_power_limit;
