...
//中点设置
#define Gimbal_Yaw_Middle_Angle  1.49f
...
void Gimbal_Init(Gimbal_t* Gimbal_Init)
{
	...
	Gimbal_Init->Gimbal_Yaw_Msg_t.Gimbal_IMU_Aspeed_Data = get_MPU6500_Gyro_Data_Point() + 2;
	Gimbal_Init->Gimbal_Pitch_Msg_t.Gimbal_IMU_Aspeed_Data = get_MPU6500_Gyro_Data_Point() + 0;
...
void Gimbal_Data_Update(Gimbal_Msg_t* Gimbal_Msg_Update)
{
	...
	Gimbal_Msg_Update->Gimbal_IMU_Angle_Msg = *(Gimbal_Msg_Update->Gimbal_IMU_Angle_Data);
...
float Mouse_X_Set = 20000.0f,Mouse_Y_Set = 20000.0f;
